							...
							<form method='post' id="new_third_page_user">
							 ...
							 <div class="row">
	                           <div class="form-group col-md-6 mt-3">
									...
									<input type="text" class="form-control border-dark" name="userName" id='user_name' minlength="3" value="<?=$registerInput['name']?>">
								</div>
	                           <div class="form-group col-md-6 mt-3">
									<label>Last Name</label>
									<input type="text" class="form-control border-dark" name="last_name" id='l_name' minlength="3" value="<?=$registerInput['l_name']?>">
								</div>
								<div class="form-group col-md-6 mt-3">
									<label>Email</label>
									<input type="email" class="form-control border-dark" name="userEmail" id='user_email' value="<?=$registerInput['email']?>">
									<input type="hidden" class="form-control user_logintype" name="userLogintype" value="<?=$login_type?>" >
								</div>
								<?php 
								if($login_type=='email'){
								...
								<div class="form-group col-md-6 mt-3">
									<label>Password</label>
									<input type="password" class="form-control border-dark" name="userPassword" id='user_password' value="<?=$registerInput['password']?>">
								</div>
								<?php } ?>
								...
								<div class="form-group col-md-6 mt-3">
									...
									<select required="true" class="form-control" name="you_are_appling_as" id="are_appling_as">
										...
										<?php 
											foreach(C_APPLINGAS as $key=>$value) {
												$select = "";
								...
								<div class="form-group col-md-4 mt-3">
									...
									<input type="text" name="house_name" id="h_name" value="" placeholder="Enter Street Address" class="form-control border-dark" value="<?=$registerInput['house_name']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
								...
								<div class="form-group col-md-4 mt-3">
									...
									<input type="text" name="postal_code2" id="p_postal_code" value="" placeholder="Enteer Postal Code" class="form-control border-dark" value="<?=$registerInput['postal_code2']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
...
<?php if(empty($this->session->userdata('id'))){?>
	<script src="<?php echo $base_url; ?>assets/js/login.js?v1.05"></script>
<?php }?>
