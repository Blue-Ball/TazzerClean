        ...
        <div class="ttr_slideshow">
           <div id="ttr_slideshow_inner">
                <ul>
                    ...
                    <li id="Slide1" class="ttr_slide" data-slideEffect="RadialBlur" style="background-image: url(&quot;<?=base_url();?>assets/img/<?=TEMPLATE_THEME?>/banner2.png&quot;);">
                        <a href="#"></a>
                        <div class="ttr_slideshow_last">
        ...
        <div data-v-60e7013d="" class="offer-col col-xl-4 col-lg-4 col-md-12 col-sm-12">
            <?php
                ...
                for ($i = 0; $i < $leftCount; $i ++) {
                    ?>
            <div data-v-60e7013d="" link="<?php echo base_url();?>service-category-detail/<?=$category[$i]['id']?>" class="offer_btn">
...
<link rel="stylesheet" href="<?=base_url()?>assets/css/<?=TEMPLATE_THEME?>/home.css?v1.11">
<script src="<?=base_url()?>assets/js/<?=TEMPLATE_THEME?>/home.js?v1.07"></script>