...
<section class="reason-tazzer-section section">
    <div class="row">
        <div class="col-12 reason-tazzer-header section-header">
            ...
            <p>We're different from your typical home cleaning company. We are out to create magic</p>
        </div>
    </div>
...
<section class="question-section section">
    <div class="row">
        <div class="col-12 question-header section-header">
            ...
            <p>We're different from your typical home cleaning company. We\re out to create magic</p>
        </div>
    </div>
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/service_categories/category_detail.css?v1.05">
...
<script src="<?php echo base_url(); ?>assets/js/service_categories/category_detail.js?v1.05"></script>
